...
from FLAlgorithms.users.userMultimodalMoon import UserMultimodalMoon
...
import copy
class MultimodalMoon(Dem_Server):
    def __init__(self, train_A, train_B, experiment, device, dataset, algorithm, model, model_server,embedding_layer,embedding_layer1, batch_size, learning_rate,
        ...
        for i in range(self.total_users):
            ...
            user = UserMultimodalMoon(device, id[i], client_train, public_data, model,  modalities[i], batch_size, learning_rate, beta,
    ...
    def train(self):
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            for user in self.selected_users:
                    ...
                    rec=user.train_ae(self.local_epochs,self.model,pre_w)
