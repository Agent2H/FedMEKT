...
def args_parser():
    ...
    parser.add_argument("--algorithm", type=str, default=Input_Alg, choices=["mmFedAvg","mmFedProx","mmMOON","FedMEKT-S","FedMEKT-C"])
    parser.add_argument("--model", type=str, default=MODEL_AE, choices=["split_LSTM"])
