...
def read_files_opp_global():
    ...
    df = h5py.File(os.path.join(directory, 'mmFedAvg_opp_LAB_TA_I100_Maacce_Mbgyro_alpha0.07_eta0.07_beta0.03_gamma0.03_SSTrue_gmKL_lmKL_ratio0.11_depoch2.h5'), 'r')
    df2 = h5py.File(os.path.join(directory, 'mmFedAvg_opp_LAB_TB_I100_Maacce_Mbgyro_alpha0.07_eta0.07_beta0.03_gamma0.03_SSTrue_gmKL_lmKL_ratio0.11_depoch2.h5'), 'r')
    df3 = h5py.File(os.path.join(directory, 'mmFedEKT_opp_LAB_TA_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerFalse_globalclsDrFalse.h5'), 'r')
    df4 = h5py.File(os.path.join(directory, 'mmFedEKT_opp_LAB_TB_I100_Maacce_Mbgyro_alpha0.01_eta0.01_beta0.007_gamma0.007_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsDrFalse.h5'), 'r')
    ...
    print("fedavg test acce local:", np.median(spec1))

    print("fedavg test gyro glob:", np.median(glob2))
    print("fedavg test gyro local:", np.median(spec2))

    print("fedekt  test acce glob:", np.median(glob3))
    print("fedekt  test acce glob 1 layer:", np.median(glob7))
    print("fedekt test acce local:", np.median(spec3))
    print("fedekt test acce local (global cls):", np.median(spec5))

    print("fedekt test gyro glob:", np.median(glob4))
    print("fedekt test gyro glob 1 layer:", np.median(glob8))
    print("fedekt test gyro local:", np.median(spec4))
    print("fedekt test gyro local (global cls):", np.median(spec6))
    #
...
def read_files1_global_mhealth():
    directory = "./results_fig/"
    df = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TA_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df2 = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TB_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df3 = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TA_I100_Maacce_Mbmage_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df4 = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TB_I100_Maacce_Mbmage_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df5 = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TA_I100_Magyro_Mbmage_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df6 = h5py.File(os.path.join(directory, 'mmFedAvg_mhealth_LAB_TB_I100_Magyro_Mbmage_alpha0.05_eta0.05_beta0.009_gamma0.009_SSTrue_gmKL_lmKL_ratio0.11_depoch1.h5'), 'r')
    df7 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.03_gamma0.03_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsDrFalse.h5'), 'r')
    df8 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbgyro_alpha0.04_eta0.04_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsFalse.h5'), 'r')
    df9 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbmage_alpha0.08_eta0.08_beta0.07_gamma0.07_SSTrue_gmKL_lmKL_ratio0.11_depoch2.h5'),   'r')
    df10 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbmage_alpha0.08_eta0.08_beta0.08_gamma0.08_SSTrue_gmKL_lmKL_ratio0.11_depoch3.h5'),'r')
    df11 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TA_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.05_gamma0.05_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerFalse_globalclsFalse.h5'), 'r')
    df12 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TB_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.06_gamma0.06_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsFalse.h5'), 'r')

    df13 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.03_gamma0.03_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerFalse_globalclsTrue.h5'), 'r')
    df14 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbgyro_alpha0.03_eta0.03_beta0.006_gamma0.006_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerFalse_globalclsTrue.h5'),'r')
    df15 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TA_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.05_gamma0.05_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerFalse_globalclsTrue.h5'),'r')
    df16 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.06_gamma0.06_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsTrue.h5'),'r')
    df17 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbgyro_alpha0.05_eta0.05_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerTrue_globalclsFalse.h5'), 'r')
    df18 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbgyro_alpha0.03_eta0.03_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerTrue_globalclsFalse.h5'),'r')
    df19 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TA_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch1_onelayerTrue_globalclsFalse.h5'),'r')
    df20 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Magyro_Mbmage_alpha0.07_eta0.07_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerTrue_globalclsFalse.h5'),'r')
    df21 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbmage_alpha0.1_eta0.1_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch3_onelayerTrue_globalclsFalse.h5'), 'r')
    df22 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbmage_alpha0.08_eta0.08_beta0.005_gamma0.005_SSTrue_gmKL_lmKL_ratio0.11_depoch3_onelayerTrue_globalclsFalse.h5'),'r')
    df23 = h5py.File(os.path.join(directory,'mmFedEKT_mhealth_LAB_TB_I100_Maacce_Mbmage_alpha0.08_eta0.08_beta0.08_gamma0.08_SSTrue_gmKL_lmKL_ratio0.11_depoch3_onelayerFalse_globalclsTrue.h5'), 'r')
    df24 = h5py.File(os.path.join(directory, 'mmFedEKT_mhealth_LAB_TA_I100_Maacce_Mbmage_alpha0.08_eta0.08_beta0.07_gamma0.07_SSTrue_gmKL_lmKL_ratio0.11_depoch2_onelayerFalse_globalclsTrue.h5'),'r')
    ...
    spec23 = df23['avg_local_f1_acc'][Table_index1:Table_index2]
    ...
    print("mmFedEKT gyro glob 1 layer:", np.median(glob18))
    print("mmFedEKT gyro local:", np.median(spec8))
    print("mmFedEKT gyro local global cls:", np.median(spec14))
    ...
    print("mmFedAvg mage local:", np.median(spec4))
    ...
    print("mmFedEKT acce local global cls:", np.median(spec24))

    print("mmFedEKT mage glob:", np.median(glob10))
    print("mmFedEKT mage glob 1 layer:", np.median(glob22))
    print("mmFedEKT mage local:", np.median(spec10))
    print("mmFedEKT mage local global cls:", np.median(spec23))

    print("---------------GYRO-MAGE --------------")
    print("mmFedAvg gyro glob:", np.median(glob5))
    print("mmFedAvg gyro local:", np.median(spec5))

    print("mmFedAvg mage glob:", np.median(glob6))
    print("mmFedAvg mage local:", np.median(spec6))

    print("mmFedEKT gyro glob:", np.median(glob11))
    print("mmFedEKT gyro glob 1 layer:", np.median(glob19))
    print("mmFedEKT gyro local:", np.median(spec11))
    print("mmFedEKT gyro local global cls:", np.median(spec15))

    print("mmFedEKT mage glob:", np.median(glob12))
    print("mmFedEKT mage glob 1 layer:", np.median(glob20))
    print("mmFedEKT mage local:", np.median(spec12))
    print("mmFedEKT mage local global cls:", np.median(spec16))
    ...
    data = np.concatenate((glob1[np.newaxis, :], glob2[np.newaxis, :], glob3[np.newaxis, :], glob4[np.newaxis, :],
                           spec1[np.newaxis, :], spec2[np.newaxis, :], spec3[np.newaxis, :], spec4[np.newaxis, :]), axis=0)
    # print(data.transpose())
    iters_cols = ['(Rep+KL-N)\nGlobal','(RepFull+KL-N)\nGlobal','(Full+KL-N)\nGlobal','FedAvg\nGlobal',
                  '(Rep+KL-N)\nC-Gen','(RepFull+KL-N)\nC-Gen','(Full+KL-N)\nC-Gen','FedAvg\nC-Gen']
    # data = np.concatenate((stop1, stop3), axis=1)
...
def read_files_global_urfall():
    ...
    df3 = h5py.File(os.path.join(directory,'mmFedAvg_ur_fall_LAB_TA_I100_Maacce_Mbdepth_alpha0.08_eta0.08_beta0.07_gamma0.07_SSTrue_gmKL_lmKL_ratio0.11_depoch2.h5'), 'r')
